...
setup_pkg() {
    ...
    if [ -n "$cross" ]; then
        # Regular tools names
        export CC="${XBPS_CROSS_TRIPLET}-${XBPS_CC}"
        export CXX="${XBPS_CROSS_TRIPLET}-${XBPS_CXX}"
        export CPP="${XBPS_CROSS_TRIPLET}-${XBPS_CPP}"
        export FC="${XBPS_CROSS_TRIPLET}-gfortran"
        export GCC="$CC"
        export LD="${XBPS_CROSS_TRIPLET}-${XBPS_LD}"
        export AR="${XBPS_CROSS_TRIPLET}-${XBPS_AR}"
        export AS="${XBPS_CROSS_TRIPLET}-${XBPS_AS}"
        export RANLIB="${XBPS_CROSS_TRIPLET}-${XBPS_RANLIB}"
        export STRIP="${XBPS_CROSS_TRIPLET}-${XBPS_STRIP}"
        export OBJDUMP="${XBPS_CROSS_TRIPLET}-${XBPS_OBJDUMP}"
        export OBJCOPY="${XBPS_CROSS_TRIPLET}-${XBPS_OBJCOPY}"
        export NM="${XBPS_CROSS_TRIPLET}-${XBPS_NM}"
        export READELF="${XBPS_CROSS_TRIPLET}-${XBPS_READELF}"
        ...
        # Host tools
        export CC_host="${XBPS_CC}"
        export CXX_host="${XBPS_CXX}"
        export CPP_host="${XBPS_CPP}"
        export GCC_host="$CC_host"
        export FC_host="gfortran"
        export LD_host="${XBPS_LD}"
        export AR_host="${XBPS_AR}"
        export AS_host="${XBPS_AS}"
        export RANLIB_host="${XBPS_RANLIB}"
        export STRIP_host="${XBPS_STRIP}"
        export OBJDUMP_host="${XBPS_OBJDUMP}"
        export OBJCOPY_host="${XBPS_OBJCOPY}"
        export NM_host="${XBPS_NM}"
        export READELF_host="${XBPS_READELF}"
        # Host flags
